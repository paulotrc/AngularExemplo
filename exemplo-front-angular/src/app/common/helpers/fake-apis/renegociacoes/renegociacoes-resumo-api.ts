...
export class RenegociacoesResumoApi extends BaseApi<ResumoAtendimentoRenegociacaoContratoMock> implements Api<ResumoAtendimentoRenegociacaoContratoMock> {
