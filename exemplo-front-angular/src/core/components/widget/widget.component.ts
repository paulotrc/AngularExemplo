...
export class CoreWidgetComponent implements AfterContentInit
{
    @HostBinding('class.flipped')
    flipped = false;

    @ContentChildren(CoreWidgetToggleDirective, {descendants: true})
    toggleButtons: QueryList<CoreWidgetToggleDirective>;
