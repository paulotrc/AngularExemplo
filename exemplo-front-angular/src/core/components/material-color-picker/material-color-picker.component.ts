...
export const CORE_MATERIAL_COLOR_PICKER_VALUE_ACCESSOR: any = {
    provide    : NG_VALUE_ACCESSOR,
    useExisting: forwardRef(() => CoreMaterialColorPickerComponent),
    multi      : true
};

@Component({
    selector     : 'core-material-color-picker',
    templateUrl  : './material-color-picker.component.html',
    styleUrls    : ['./material-color-picker.component.scss'],
    animations   : coreAnimations,
    encapsulation: ViewEncapsulation.None,
    providers    : [CORE_MATERIAL_COLOR_PICKER_VALUE_ACCESSOR]
})
export class CoreMaterialColorPickerComponent implements ControlValueAccessor
{
    colors: any;
    hues: string[];
    view: string;
    ...
    set color(value)
    {
        ...
        // Split the color value (red-400, blue-500, core-navy-700 etc.)
